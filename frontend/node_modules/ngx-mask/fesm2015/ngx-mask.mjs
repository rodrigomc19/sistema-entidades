    ...
    constructor() {
        ...
        this._formatWithSeparators = (str, thousandSeparatorChar, decimalChars, precision) => {
            ...
            if (Array.isArray(decimalChars)) {
                ...
                x = str.split(regExp);
                decimalChar = (_b = (_a = str.match(regExp)) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : "" /* MaskExpression.EMPTY_STRING */;
            }
            else {
            ...
            let res = (_c = x[0]) !== null && _c !== void 0 ? _c : "" /* MaskExpression.EMPTY_STRING */;
    ...
    cb = () => { }) {
        ...
        for (let i = 0; i < inputValue.length; i++) {
            if ((_a = inputValue[i]) === null || _a === void 0 ? void 0 : _a.match('\\d')) {
                arr.push((_b = inputValue[i]) !== null && _b !== void 0 ? _b : "" /* MaskExpression.EMPTY_STRING */);
            }
        }
        ...
        if (maskExpression.startsWith("percent" /* MaskExpression.PERCENT */)) {
            ...
            let i = 0, inputSymbol = inputArray[0]; i < inputArray.length; i++, inputSymbol = (_c = inputArray[i]) !== null && _c !== void 0 ? _c : "" /* MaskExpression.EMPTY_STRING */) {
                if (cursor === maskExpression.length) {
                    break;
                }
                const symbolStarInPattern = "*" /* MaskExpression.SYMBOL_STAR */ in this.patterns;
                if (this._checkSymbolMask(inputSymbol, (_d = maskExpression[cursor]) !== null && _d !== void 0 ? _d : "" /* MaskExpression.EMPTY_STRING */) &&
                    ...
                    multi &&
                    this._checkSymbolMask(inputSymbol, (_e = maskExpression[cursor + 2]) !== null && _e !== void 0 ? _e : "" /* MaskExpression.EMPTY_STRING */)) {
                    result += inputSymbol;
                    cursor += 3;
                    multi = false;
                }
                else if (this._checkSymbolMask(inputSymbol, (_f = maskExpression[cursor]) !== null && _f !== void 0 ? _f : "" /* MaskExpression.EMPTY_STRING */) &&
                    ...
                    this._checkSymbolMask(inputSymbol, (_g = maskExpression[cursor + 2]) !== null && _g !== void 0 ? _g : "" /* MaskExpression.EMPTY_STRING */)) {
                    result += inputSymbol;
                    cursor += 3;
                }
                else if (this._checkSymbolMask(inputSymbol, (_h = maskExpression[cursor]) !== null && _h !== void 0 ? _h : "" /* MaskExpression.EMPTY_STRING */)) {
                ...
                else if (this.specialCharacters.indexOf((_j = maskExpression[cursor]) !== null && _j !== void 0 ? _j : "" /* MaskExpression.EMPTY_STRING */) !== -1) {
                ...
                else if (this.patterns[(_k = maskExpression[cursor]) !== null && _k !== void 0 ? _k : "" /* MaskExpression.EMPTY_STRING */] &&
                    ((_m = this.patterns[(_l = maskExpression[cursor]) !== null && _l !== void 0 ? _l : "" /* MaskExpression.EMPTY_STRING */]) === null || _m === void 0 ? void 0 : _m.optional)) {
                    if (!!inputArray[cursor] &&
                        maskExpression !== '099.099.099.099' &&
                        maskExpression !== '000.000.000-00' &&
                        maskExpression !== '00.000.000/0000-00' &&
                        !maskExpression.match(/^9+\.0+$/) &&
                        !((_p = this.patterns[(_o = maskExpression[cursor]) !== null && _o !== void 0 ? _o : "" /* MaskExpression.EMPTY_STRING */]) === null || _p === void 0 ? void 0 : _p.optional)) {
                    ...
                    this._findSpecialChar((_q = this.maskExpression[cursor + 2]) !== null && _q !== void 0 ? _q : "" /* MaskExpression.EMPTY_STRING */) &&
                    ...
                    this._findSpecialChar((_r = this.maskExpression[cursor + 2]) !== null && _r !== void 0 ? _r : "" /* MaskExpression.EMPTY_STRING */) &&
                    this._findSpecialChar(inputSymbol) === this.maskExpression[cursor + 2] &&
                    multi) {
                    cursor += 3;
                    result += inputSymbol;
        ...
        if (result.length + 1 === maskExpression.length &&
            this.specialCharacters.indexOf((_s = maskExpression[maskExpression.length - 1]) !== null && _s !== void 0 ? _s : "" /* MaskExpression.EMPTY_STRING */) !== -1) {
...
class NgxMaskService extends NgxMaskApplierService {
    ...
    cb = () => { }) {
        ...
        const getSymbol = !!inputValue && typeof this.selStart === 'number'
            ? (_a = inputValue[this.selStart]) !== null && _a !== void 0 ? _a : "" /* MaskExpression.EMPTY_STRING */
            : "" /* MaskExpression.EMPTY_STRING */;
        let newInputValue = '';
    ...
    hideInput(inputValue, maskExpression) {
        return inputValue
            ...
            var _a, _b, _c, _d, _e;
            if (this.patterns &&
                this.patterns[(_a = maskExpression[index]) !== null && _a !== void 0 ? _a : "" /* MaskExpression.EMPTY_STRING */] &&
                ((_c = this.patterns[(_b = maskExpression[index]) !== null && _b !== void 0 ? _b : "" /* MaskExpression.EMPTY_STRING */]) === null || _c === void 0 ? void 0 : _c.symbol)) {
                return (_e = this.patterns[(_d = maskExpression[index]) !== null && _d !== void 0 ? _d : "" /* MaskExpression.EMPTY_STRING */]) === null || _e === void 0 ? void 0 : _e.symbol;
            }
            return curr;
        })
            .join("" /* MaskExpression.EMPTY_STRING */);
    ...
    getActualValue(res) {
        const compare = res
            ...
            .filter((symbol, i) => {
            var _a;
            const maskChar = (_a = this.maskExpression[i]) !== null && _a !== void 0 ? _a : "" /* MaskExpression.EMPTY_STRING */;
    ...
    shiftTypedSymbols(inputValue) {
        ...
        const newInputValue = (inputValue &&
            inputValue
                ...
                var _a;
                if (this.specialCharacters.includes((_a = inputValue[index + 1]) !== null && _a !== void 0 ? _a : "" /* MaskExpression.EMPTY_STRING */) &&
    ...
    _checkForIp(inputVal) {
        ...
        for (let i = 0; i < inputVal.length; i++) {
            const value = (_a = inputVal[i]) !== null && _a !== void 0 ? _a : "" /* MaskExpression.EMPTY_STRING */;
            if (!value) {
                continue;
            }
            if (value.match('\\d')) {
            ...
            if (this._maskValue.indexOf("{" /* MaskExpression.CURLY_BRACKETS_LEFT */) === 1 &&
                value.toString().length ===
                    this._maskValue.length +
                        Number(((_b = this._maskValue.split("{" /* MaskExpression.CURLY_BRACKETS_LEFT */)[1]) !== null && _b !== void 0 ? _b : "" /* MaskExpression.EMPTY_STRING */).split("}" /* MaskExpression.CURLY_BRACKETS_RIGHT */)[0]) -
                        4) {
                return null;
            }
        ...
        if (el.type !== 'number') {
            if (typeof transformedValue === 'string' || typeof transformedValue === 'number') {
                ...
                if (this.showMaskTyped &&
                    ...
                    const checkSymbols = this._maskService._checkSymbolMask(inputSymbol, (_a = this._maskService.maskExpression[position - 1 - prefixLength]) !== null && _a !== void 0 ? _a : "" /* MaskExpression.EMPTY_STRING */);
                    const checkSpecialCharacter = this._maskService._checkSymbolMask(inputSymbol, (_b = this._maskService.maskExpression[position + 1 - prefixLength]) !== null && _b !== void 0 ? _b : "" /* MaskExpression.EMPTY_STRING */);
                ...
                if (e.key === "Backspace" /* MaskExpression.BACKSPACE */ && el.selectionStart !== 0) {
                    ...
                    if (this.prefix.length > 1 &&
                        ...
                        if (this._inputValue.length !== el.selectionStart &&
                            el.selectionStart !== 1) {
                            while (this.specialCharacters.includes(((_b = this._inputValue[el.selectionStart - 1]) !== null && _b !== void 0 ? _b : "" /* MaskExpression.EMPTY_STRING */).toString()) &&
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof controlValue === 'string' ||
                ...
                if (typeof inputValue === 'number' ||
                    ...
                    if (((_a = this.maskExpression) === null || _a === void 0 ? void 0 : _a.startsWith("separator" /* MaskExpression.SEPARATOR */)) && this.leadZero) {
        ...
        this._maskExpressionArray.some((mask) => {
            ...
            if ((specialChart && this._inputValue && !mask.includes("S" /* MaskExpression.LETTER_S */)) ||
                ...
                if (test) {
                    ...
                    const expression = (_c = this._maskExpressionArray[this._maskExpressionArray.length - 1]) !== null && _c !== void 0 ? _c : "" /* MaskExpression.EMPTY_STRING */;
                    this._maskValue =
                        this.maskExpression =
                            this._maskService.maskExpression =
                ...
                const check = (_d = this._inputValue) === null || _d === void 0 ? void 0 : _d.split("" /* MaskExpression.EMPTY_STRING */).every((character, index) => {
