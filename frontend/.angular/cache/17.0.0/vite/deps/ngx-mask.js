...
NgxMaskApplierService.ɵprov = ɵɵdefineInjectable({
...
NgxMaskService.ɵfac = (() => {
  ...
  return function NgxMaskService_Factory(t) {
    return (ɵNgxMaskService_BaseFactory || (ɵNgxMaskService_BaseFactory = ɵɵgetInheritedFactory(NgxMaskService)))(t || NgxMaskService);
  };
})();
NgxMaskService.ɵprov = ɵɵdefineInjectable({
...
var NgxMaskDirective = class {
  ...
  writeValue(controlValue) {
    return __async(this, null, function* () {
      ...
      if (typeof controlValue === "string" || typeof controlValue === "number" || controlValue === null) {
  ...
  _setMask() {
    this._maskExpressionArray.some((mask) => {
      ...
      if (specialChart && this._inputValue && !mask.includes(
        ...
        const check = this._inputValue?.split(
          ""
          /* MaskExpression.EMPTY_STRING */
...
NgxMaskDirective.ɵdir = ɵɵdefineDirective({
...
NgxMaskPipe.ɵpipe = ɵɵdefinePipe({
  name: "mask",
  type: NgxMaskPipe,
  pure: true,
  standalone: true
